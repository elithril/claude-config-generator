...
export function generateClaudeMd(config: ClaudeConfig): string {
  ...
  const commentMap: Record<string, string> = {
    fr: "<!-- Ce fichier contient les instructions que Claude suit dans ce projet. Généré par Claude Config Generator. -->",
    en: "<!-- This file contains the instructions Claude follows in this project. Generated by Claude Config Generator. -->",
    es: "<!-- Este archivo contiene las instrucciones que Claude sigue en este proyecto. Generado por Claude Config Generator. -->",
  };

  const sections: string[] = [];
  sections.push(`${commentMap[lang] || commentMap.fr}\n`);
...
export function generateClaudeIgnore(config: ClaudeConfig): string {
  ...
  const lines: string[] = [
    "# Files invisible to Claude (like .gitignore for AI)",
    "# Fichiers invisibles pour Claude (comme .gitignore pour l'IA)",
    "",
    "# Dependencies",
    "node_modules/",
    "",
